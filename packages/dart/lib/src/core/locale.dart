...
const String _iso6391 =
    ...
    'no nr nv ny oc oj om or os pa pi pl ps pt qu rm rn ro ru rw sa sc sd se sg si sk sl sm sn '
    'so sq sr ss st su sv sw ta te tg th ti tk tl tn to tr ts tt tw ty ug uk ur uz ve vi vo wa '
    'wo xh yi yo za zh zu';

final Set<String> _knownLocales = _iso6391.split(' ').toSet();
...
bool isLocaleCode(String name) {
  if (name.isEmpty) {
    return false;
  }

  return _knownLocales.contains(name.toLowerCase().split(RegExp('[-_]')).first);
}
